...
import com.tatadigital.api.UpdateCustomerDetailsMethod;

public class Post_UpdateCustomerDetails extends AbstractTest {
	...
	@XlsDataSourceParameters(path = "xls/TataDigital.xlsx", sheet = "UpdateCustDetails",dsArgs = "TC_Desc,mobile,email,external_id,firstname,lastname", dsUid = "TestCaseID",executeValue = "Y")
	public void updatecustdetails(String TC_Desc,String mobile,String email,String external_id,String firstname,String lastname) throws Exception 
	{
	
		 	
	UpdateCustomerDetailsMethod api= new UpdateCustomerDetailsMethod();
